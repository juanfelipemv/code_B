                                    ...
                                    list<Personaje*>*personajes)
{
    ...
    rayo_texture2 = IMG_LoadTexture(renderer,"assets/rayo2.png");
    SDL_QueryTexture(rayo_texture2, NULL, NULL,&this->rayo_rect2.w,&this->rayo_rect2.h);
    rayo_activado2=false;

    rayo_cooldown2 = 100;
    rayo_frame_actual2 = 0;
...
void PersonajeJugador::logic(Uint8* teclas_presionadas)
{
    ...
    if(rayo_activado2)
        rayo_frame_actual2++;
    if(rayo_frame_actual2>=rayo_cooldown2)
        rayo_activado2=false;
    ...
    if(teclas_presionadas[SDL_SCANCODE_X] && !rayo_activado2)
    {
        rayo_activado2=true;
        rayo_frame_actual2=0;
        rayo_rect2.x = rectangulo.x;
        rayo_rect2.y = rectangulo.y;
        rayo_rect2.x+=rectangulo.w;
            ...
            i++)
    {
        if(this==(*i))
            continue;
        if(colision(this->rayo_rect2, (*i)->rectangulo))
        {
            //rectangulo=temp;
            personajes->erase(i);
            rayo_activado2=false;
...
void PersonajeJugador::render(SDL_Renderer* renderer)
{
    ...
    if(rayo_activado2)
    {
        SDL_RenderCopy(renderer,rayo_texture2, NULL,&rayo_rect2);
    }
}
