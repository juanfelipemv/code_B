...
vector<Tile*> cargarTiles(string nombre_archivo)
{
    ...
    for(int ubicacion_y=0; ubicacion_y<8; ubicacion_y++)
    {
        for(int ubicacion_x=0; ubicacion_x<16; ubicacion_x++)
        {
            int origen_x;
            int origen_y;
            archivo>>origen_x;
...
int main( int argc, char* args[] )
{
    ...
    personajes.push_back(new Personaje1(100,200,renderer,&personajes));
...
//    personajes.push_back(new NPC (50,150,renderer,&personajes));
    ...
    vector<Tile*>tiles2=cargarTiles("assets/tile2.txt");
